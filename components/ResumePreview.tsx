    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">See how your resume looks with the {settings.template} template</p>
        </div>
      ...
      <div className="bg-gray-100 p-6 rounded-xl overflow-auto" style={{ maxHeight: '80vh' }}>
        <div ref={resumeRef} className="transform scale-90 origin-top transition-transform hover:scale-95">
          {renderTemplate()}
        </div>
      </div>
